"""
Django settings for hashflix_setup project.
...
SECRET_KEY = "django-insecure-s(-o1n81a35z0peshwltq$ae585*7j-%baz*d51#==%*w(d)%&"
...
ROOT_URLCONF = "hashflix_setup.urls"
...
WSGI_APPLICATION = "hashflix_setup.wsgi.application"
...
# Pagina a ser exibida apos fazer login
LOGIN_REDIRECT_URL = 'filme:homeFilmes'

# Pagina para usuario realizar o login
